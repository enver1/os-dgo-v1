...
$directorio='estadoactividad'; // ** CAMBIAR **
/* Nombre de la tabla  */
$sNtabla='hdrEstadoActividad'; // ** CAMBIAR **
/*---------------------------------------------*/
...
/*-----------------** CAMBIAR **-----------------------------------------------------------------*/
$sqltable=urlencode("select a.idHdrEstadoActividad,a.descripcion,b.descripcion as estadoGenEstado from hdrEstadoActividad a, genEstado b where a.idGenEstado=b.idGenEstado"); 
/*-----------------------------------------------------------------------------------------------*/
