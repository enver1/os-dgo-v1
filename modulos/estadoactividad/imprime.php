...
$nombreReporte='CATALOGO DE ESTADOS DE RECURSOS DE ESTADO DE LA ACTIVIDAD'; // *** CAMBIAR *** TITULO DEL REPORTE
/* Contiene la instruccion select que trae los datos de la tabla */
// *** CAMBIAR ***/
$sql="select 
	a.idHdrEstadoActividad cero,
	a.descripcion uno,
	b.idGenEstado dos
	from hdrEstadoActividad a, genEstado b where a.idGenEstado=b.idGenEstado
	order by 3,2 ";
//echo $sql;
$rs=$conn->query($sql);
$row = $rs->fetchAll();
...
$header=array('Codigo','Descripcion','Estado');
//*** CAMBIAR *** 
...
$pdf->FancyTable($header,$row,200,220,255,0,3,15,135,40,0,0);
/*-------------------------------------------------------*/
$pdf->Output();
