...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $idDgoComisios = strip_tags($_GET['idR']);
    $sqltable         = $encriptar->getEncriptar($Comisios->getSqlComisios($idDgoComisios), $_SESSION['usuarioAuditar']);
?>
...
<script>
    $(function() {
        $('#formAyuda').load('modulos/recintosElectorales/includes/formularioAyuda.php?bn=<?php echo $_GET['opc'] ?>&id=<?php echo (isset($_GET['idR']) ? $_GET['idR'] : 0) ?>');
    });
</script>