...
function pesta(n)
{	
	if(($('#idRecinto').val()!=0 && $('#idRecinto').val()!='' && $('#idRecinto').val()!=undefined) || n==1) {

        var nP=1;
		var urlt = 'modulos/recintosElectorales/paso'+n+'/aplicacion.php?opc=<?php echo $_GET['opc'] ?>&idR='+$('#idRecinto').val()+'&idDgoT='+$('#idDgoT').val();
