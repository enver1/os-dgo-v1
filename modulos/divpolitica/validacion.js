...
with (thisform)
  {
	  ...
	  if (validate_combo(idGenTipoDivision,"Tipo de Division")==false)
	  {idGenTipoDivision.focus();return false;}
	  if (validate_enteros(paisCdg,"La Division Politica",1,999999)==false)
	  {paisCdg.focus();return false;}
  }
	return true;
}
