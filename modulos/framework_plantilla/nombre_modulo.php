...
$directorio='materias'; // ** CAMBIAR **
/* Nombre de la tabla  */
$sNtabla='dneMateria'; // ** CAMBIAR **
/*---------------------------------------------*/
...
/*-----------------** CAMBIAR **-----------------------------------------------------------------*/
$sqltable=urlencode("select a.idDneMateria,a.descripcion,b.descripcion idGenEstado,c.descripcion idDneTipoPrueba from dneMateria a,genEstado b,dneTipoPrueba c where a.idGenEstado=b.idGenEstado and a.idDneTipoPrueba=c.idDneTipoPrueba"); 
/*-----------------------------------------------------------------------------------------------*/
