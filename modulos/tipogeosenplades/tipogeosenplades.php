...
$directorio = 'tipogeosenplades'; // ** CAMBIAR **
/* Nombre de la tabla  */
$sNtabla = 'genTipoGeoSenplades'; // ** CAMBIAR **
/*---------------------------------------------*/
...
/*-----------------** CAMBIAR **-----------------------------------------------------------------*/
$sqltable = urlencode("select a.idGenTipoGeoSenplades,a.descripcion from genTipoGeoSenplades a");
/*-----------------------------------------------------------------------------------------------*/
