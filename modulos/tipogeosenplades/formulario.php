...
/*-------------------------------------------------*/
$tgraba = 'tipogeosenplades/graba.php'; // *** CAMBIAR *** nombre del php para insertar o actualizar un registro
$Ntabla = 'genTipoGeoSenplades'; // *** CAMBIAR *** Nombre de la Tabla
$directorio = 'modulos/tipogeosenplades'; // *** CAMBIAR ***
/*-------------------------------------------------*/
