...
$xsql = "select idDgoEjeProcSu,descDgoEje descripcion from dgoEjeProcSu a,dgoEje b where a.idDgoEje=b.idDgoEje and a.idDgoProcSuper=" . $_GET['opc'];
//echo $xsql;
$formulario = array(
    7 => array(
        'tipo' => 'comboSQL',
        'etiqueta' => 'Eje',
        'campoTabla' => 'idDgoEjeProcSu',
        'tabla' => 'dgoEjeProcSu',
        'ancho' => '400',
        'sql' => $xsql,
        'onclick' => '',
            ...
            <table width="100%" border="0">
                <tr style="display:none">
                    ...
                    <td>
                        ...
                        <input type="hidden" name="idDgoProcSuper" id="idDgoProcSuper" value="<?php echo isset($_GET['opc']) ? $_GET['opc'] : $rowt['idDgoProcSuper'] ?>">
                    </td>
                </tr>
                <?php /*==================//  *** CAMBIAR *** // ===========================*/
