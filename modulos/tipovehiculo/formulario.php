...
/*-------------------------------------------------*/
$tgraba = 'tipovehiculo/graba.php'; // *** CAMBIAR *** nombre del php para insertar o actualizar un registro
$Ntabla = 'genTipVehi'; // *** CAMBIAR *** Nombre de la Tabla
$directorio = 'modulos/tipovehiculo'; // *** CAMBIAR ***
/*-------------------------------------------------*/
