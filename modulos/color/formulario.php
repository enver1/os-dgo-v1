...
/*-------------------------------------------------*/
$tgraba = 'color/graba.php'; // *** CAMBIAR *** nombre del php para insertar o actualizar un registro
$Ntabla = 'genColor'; // *** CAMBIAR *** Nombre de la Tabla
$directorio = 'modulos/color'; // *** CAMBIAR ***
/*-------------------------------------------------*/
