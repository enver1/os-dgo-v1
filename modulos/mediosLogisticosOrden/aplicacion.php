...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $sqltable  = $encriptar->getEncriptar($mediosLogisticosOrden->getSqlMediosLogisticosOrden(), $_SESSION['usuarioAuditar']);
...
?>
<script type="text/javascript" src="<?php echo '../' . $directorio ?>/validacionT.js"></script>