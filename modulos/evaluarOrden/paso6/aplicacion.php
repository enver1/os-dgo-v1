...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $dgoEjeDgoEjemplarInforme      = new DgoEjemplarInforme;
    $encriptar       = new Encriptar;
    $sqltable        = $encriptar->getEncriptar($dgoEjeDgoEjemplarInforme->getSqlDgoEjemplarInforme($_GET['id']), $_SESSION['usuarioAuditar']);
