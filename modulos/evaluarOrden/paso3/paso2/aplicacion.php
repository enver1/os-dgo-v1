...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $sqltable        = $encriptar->getEncriptar($DgoMediosLogisticosInf->getSqlDgoMediosLogisticosInf($_GET['id']), $_SESSION['usuarioAuditar']);
...
<script>
    $(function() {
        $('#formTituloMl').load('modulos/evaluarOrden/paso3/includes/formTituloMedios.php');
