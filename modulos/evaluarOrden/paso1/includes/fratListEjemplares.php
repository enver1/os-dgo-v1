...
$dgoEjemplarOrden  = new DgoEjemplarInforme;
                    ...
                    <div id="contenido" style="width:85%">
                        <table id='my-tbl' class="table1" style="width:100%;">
                            ...
                            <tbody>
                                <?php
                                $id = $_GET['id'];
                                $sql    = $dgoEjemplarOrden->getSqlDgoEjemplarInforme($id);
                                $a      = "Imprimir";
...
<script>
    ...
    function seleccionar(idDgoInfOrdenServicio, ejemplar) {
        var idDgoInfOrdenServicio = idDgoInfOrdenServicio;
        var url = "../../../../modulos/evaluarOrden/paso8/imprimeEjemplar.php?id=" + idDgoInfOrdenServicio + "&ejemplar=" + ejemplar;
        var l = screen.width;
        var t = screen.height;
