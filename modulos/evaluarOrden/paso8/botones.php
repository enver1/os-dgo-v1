...
<table border="0">
	<tr>
		<td colspan="2">
			<?php if ($row['verificado'] == 'N') { ?>
				<a href="javascript:void(0)" onclick="return verifica(<?php echo $idDgoInfOrdenServicio ?>)">
	...
	<tr>
		<td colspan="2">
			<?php if ($row['procesado'] == 'S' and $row['verificado'] == 'S' and $row['estadoInforme'] == 'VALIDADA') { ?>
