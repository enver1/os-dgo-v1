	...
	foreach ($data as $row) {
		...
		if (isset($_SESSION['privilegios']) && substr($_SESSION['privilegios'], 1, 1) == 1) {
			if ($simple != 1) {
				...
				echo '<td>
                        <a href="javascript:void(0)" onclick="getregistro(\'' . $row[$idcampo] . '\')"><center><img src="../imagenes/btnEditar.png" width="20" height="20"></center></a>
                     </td>';
				echo '<td>
					 <a href="javascript:void(0)" onclick="delregistro(\'' . $row[$idcampo] . '\')"><center><img src="../imagenes/btnEliminar.png" width="20" height="20"></center></a>
				  </td>';
			}
		} else {
