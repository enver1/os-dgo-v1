...
function validate_unidad(field, alerttxt) {
    with(field) {
...
function validate_combo(field, alerttxt) {
    ...
    with(field) {
        if (value == "0" || value == "" || value == " ") {
            alert('Seleccione un valor en el campo ' + alerttxt);
            return false;
        } else {
            return true;
        }
...
function validate(thisform) {
    with(thisform) {
        if (validate_unidad(idDgpUnidad, "La unidad policial no ha sido seleccionada o") == false) {
            btnUnidad.click();
            return false;
        }
        if (validate_unidad(idGenVehiculo, "El vehiculo no ha sido seleccionado o") == false) {
            btnVehiculo.click();
            return false;
        }
        ...
        if (validate_unidad(fechaAsig, "Fecha de Asignacion") == false) {
            fechaAsigID.click();
            return false;
        }
    }
