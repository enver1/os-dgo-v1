...
class calificacion
{
	...
	public function generarSqlCalificaciones($conn,$anio,$idGenGeoSenplades=0)
	{
			...
			foreach ($indicadores as $keyUno => $valueUno) {
				foreach ($valueUno as $keyDos => $valueDos) {
					if($valueDos['regla']==='I'){
						...
						if ($keyDos==0) {
							$vioDelin.=" ( IF(c.".$valueDos['campoTabla']."<=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)*".$valueDos['datoCalif']."/c.".$valueDos['campoTabla'].") ";
						} else {
							$vioDelin.=" + IF(c.".$valueDos['campoTabla']."<=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)*".$valueDos['datoCalif']."/c.".$valueDos['campoTabla'].") ";
						}
					}
						...
						switch ($valueDos['datoCalif']) {
									case 5:
										...
										if ($keyDos==0 or $grupo5==1) {
											$stG5.="IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										} else {
											$stG5.=" + IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										}
									...
									case 4:
										...
										if ($keyDos==0 or $grupo4==1) {
											$stG4.="IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										} else {
											$stG4.=" + IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										}
									...
									case 3:
										...
										if ($keyDos==0 or $grupo3==1) {
											$stG3.="IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										} else {
											$stG3.=" + IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										}
									...
									case 2:
										...
										if ($keyDos==0 or $grupo2==1) {
											$stG2.="IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										} else {
											$stG2.=" + IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										}
									...
									case 1:
										...
										if ($keyDos==0 or $grupo1==1) {
											$stG1.="IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										} else {
											$stG1.=" + IF(c.".$valueDos['campoTabla'].">=((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2),".$valueDos['datoCalif'].",".$valueDos['datoCalif']." * c.".$valueDos['campoTabla']." / ((a.".$valueDos['campoTabla']." + b.".$valueDos['campoTabla'].") / 2)) ";
										}
		...
		LEFT JOIN dgoDatos c ON a.idGenGeoSenplades = c.idGenGeoSenplades AND a.idGenMes = c.idGenMes AND c.anio = ".($anio)." 
		join genGeoSenplades gp on a.idGenGeoSenplades=gp.idGenGeoSenplades
		where a.anio=".($anio-2)." ORDER BY gp.codigoSenplades, a.idGenMes";*/
