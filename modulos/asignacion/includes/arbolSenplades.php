    ...
    $(document).ready(function() {
      $('#tpais').tree({
        onClick: function(node) {
          ...
          $('#siglasGS').attr('value', node.attributes[0] + " (" + node.text + ")");
          $('#paisCdg').attr('value', node.id);
          $('#nivel').attr('value', node.attributes[1]);
          $("html, body").animate({
            scrollTop: 0
          }, "slow");
        }
    ...
    <div id="top" style="background-image:none">
      <div id="faux" style="background-image:none">
        <div style="border-bottom:solid 2px #bbb;width:100%;text-align:center">
          <img src="../../../../imagenes/helpArbol.jpg" alt="" />
        </div>
              ...
              <table width="100">
                <tr>
                  <td>
                    ...
                    <input type="hidden" name="nivel" id="nivel" size="" readonly="readonly" value="" />
                ...
                <tr>
                  <td width="100%">
                    <div style=" overflow: scroll; height:auto;width:890px">
                      <ul id="tpais" class="easyui-tree" animate="true" style="font-size:10px" url="treeViewSenplades.php?id=<?php echo (isset($_GET['id']) ? $_GET['id'] : 0) ?><?php echo isset($_GET['pais']) ? '&pais=' . $_GET['pais'] : '' ?><?php echo isset($_GET['parroquia']) ? '&parroquia=' . $_GET['parroquia'] : '' ?>">
                      </ul>
                    </div>
                  </td>
                </tr>
