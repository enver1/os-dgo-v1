...
{
with (thisform)
  {	  if (validate_combo(idDgoEje,'Eje')==false)

					{idDgoEje.focus();return false;}
	  if (validate_combo(idDgoProcSuper,'Proceso Supervision')==false)

					{idDgoProcSuper.focus();return false;}
	  if (validate_required(objEspecifico,'Objetivo Especifico')==false)

					{objEspecifico.focus();return false;}
	  if (validate_required(estrategia,'Estrategia')==false)

					{estrategia.focus();return false;}
	  if (validate_required(objOperativo,'Objetivo Operativo')==false)

					{objOperativo.focus();return false;}
