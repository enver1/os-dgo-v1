...
/*-------------------------------------------------*/
$tgraba = 'combustible/graba.php'; // *** CAMBIAR *** nombre del php para insertar o actualizar un registro
$Ntabla = 'genCombus'; // *** CAMBIAR *** Nombre de la Tabla
$directorio = 'modulos/combustible'; // *** CAMBIAR ***
/*-------------------------------------------------*/
