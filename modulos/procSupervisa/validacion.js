...
with (thisform)
  {	  
	  if (validate_combo(idGenEstado,'Estado')==false)
		{idGenEstado.focus();return false;}
	  if (validate_required(descripcion,'Descripcion')==false)
	  ...
	  if (validate_fecha_registro(fechaInicio,fechaHoy,'mayor','Fecha Inicio')==false)
		{fechaInicio.focus();return false;}
	  if (validate_fecha(fechaFinal,'Fecha Final')==false)
		{fechaFinal.focus();return false;}
	  if (validate_fecha_registro(fechaFinal,fechaInicio,'menor','Fecha Final')==false)
		{fechaFinal.focus();return false;}
  }
	return true;
}
