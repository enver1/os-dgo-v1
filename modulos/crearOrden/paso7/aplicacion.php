...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $dgoEjeDgoEjemplarOrden      = new DgoEjemplarOrden;
    $encriptar       = new Encriptar;
    $sqltable        = $encriptar->getEncriptar($dgoEjeDgoEjemplarOrden->getSqlDgoEjemplarOrden($_GET['id']), $_SESSION['usuarioAuditar']);
