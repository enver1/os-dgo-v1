...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $sqltable        = $encriptar->getEncriptar($dgoFuerzasAlternativas->getSqlDgoFuerzasAlternativas($_GET['id']), $_SESSION['usuarioAuditar']);
...
<script>
    $(function() {
        $('#formTituloFA').load('modulos/crearOrden/paso6/includes/formTituloFuerzasA.php');
