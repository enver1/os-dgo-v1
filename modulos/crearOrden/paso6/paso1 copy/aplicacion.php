...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $sqltable        = $encriptar->getEncriptar($dgoFuerzasPropias->getSqlDgoFuerzasPropias($_GET['id']), $_SESSION['usuarioAuditar']);
...
<script>
    $(function() {
        $('#formTituloFP').load('modulos/crearOrden/paso6/includes/formTituloFuerzasP.php');
