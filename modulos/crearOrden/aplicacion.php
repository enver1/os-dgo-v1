...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $pestana      = array(
        ...
        4 => array(
            'pestaN' => '4',
            'pestaD' => '4. Instrucciones Generales',
        ),
        5 => array(
            'pestaN' => '5',
            'pestaD' => '5. Instrucciones Pariculares',
        ),
        6 => array(
            'pestaN' => '6',
            'pestaD' => '6. Personal y Medios',
        ),

        7 => array(
            'pestaN' => '7',
            'pestaD' => '7. Regsitro de Ejemplares',
        ),
        8 => array(
            'pestaN' => '8',
            'pestaD' => '8. Regsitro de Anexos',
        ),
        9 => array(
            'pestaN' => '9',
            'pestaD' => '9. Validación e Impresión',
        ),
    );
    $nPes = count($pestana);
    echo '<link href="../../../../css/stylePesta.css" rel="stylesheet" type="text/css" />';

    $nombre = 'CREAR ORDEN DE SERVICIO DEL ' . $distrito;
...
<?php
    ...
    die('<p class="col3" style="width:90%;margin:5px auto;"><span class="texto_azul" style="font-size:12px">El Usuario NO tiene asignado un Distrito para Crear Orden de Servicio. Favor Tome Contacto con el Subadministrador DGSCOP</span></p>');
}
