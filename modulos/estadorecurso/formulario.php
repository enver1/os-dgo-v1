...
/*-------------------------------------------------*/
$tgraba='estadorecurso/graba.php'; // *** CAMBIAR *** nombre del php para insertar o actualizar un registro
$Ntabla='hdrEstadoRecurso'; // *** CAMBIAR *** Nombre de la Tabla
$directorio='modulos/estadorecurso'; // *** CAMBIAR ***
/*-------------------------------------------------*/
