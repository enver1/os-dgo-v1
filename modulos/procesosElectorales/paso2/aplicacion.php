...
if (isset($_SESSION['usuarioAuditar'])) {
    ...
    $idDgoProcElec = strip_tags($_GET['idR']);
    $sqltable         = $encriptar->getEncriptar($Comisios->getSqlComisiosP($idDgoProcElec), $_SESSION['usuarioAuditar']);
?>
...
<script>
    $(function() {
        $('#formAyuda').load('modulos/procesosElectorales/includes/formularioAyuda.php?bn=<?php echo $_GET['opc'] ?>&id=<?php echo (isset($_GET['idR']) ? $_GET['idR'] : 0) ?>');
    });
</script>