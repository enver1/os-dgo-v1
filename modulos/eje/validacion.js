...
{
with (thisform)
  {	  if (validate_required(descDgoEje,'Descripcion')==false)

					{descDgoEje.focus();return false;}
	  if (validate_required(indicador,'Indicador')==false)

					{indicador.focus();return false;}
	  if (validate_required(sentido,'Sentido')==false)

					{sentido.focus();return false;}
