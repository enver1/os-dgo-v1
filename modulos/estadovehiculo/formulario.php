...
/*-------------------------------------------------*/
$tgraba = 'estadovehiculo/graba.php'; // *** CAMBIAR *** nombre del php para insertar o actualizar un registro
$Ntabla = 'genEstVehi'; // *** CAMBIAR *** Nombre de la Tabla
$directorio = 'modulos/estadovehiculo'; // *** CAMBIAR ***
/*-------------------------------------------------*/
