...
$formulario = array(
	array(
		'tipo' => 'comboSQL',
		'etiqueta' => 'Cargo Responsable:',
		'campoTabla' => 'idDgoCargo',
		'tabla' => 'dgoCargo',
		'ancho' => '400',
		'sql' => 'SELECT idDgoCargo, descDgoCargo descripcion FROM dgoCargo ORDER BY 2',
		'onclick' => '',
		'soloLectura' => 'false'
	),
);
...
if (isset($_GET['c'])) {
	...
	$sql = "SELECT a.*, b.descDgoCargo FROM dgoResAct a, dgoCargo b 
	WHERE a.idDgoCargo=b.idDgoCargo AND a.idDgoActividad='" . $_GET['act'] . "' AND a.idDgoVisita='" . $_GET['vst'] . "' AND a.idDgoResAct='" . $_GET['c'] . "'";
	...
	<table width="100%" border="0">
		<tr style="display:none">
			...
			<td>
				...
				<input type="hidden" name="idDgoActividad" id="idDgoActividad" value="<?php echo isset($_GET['act']) ? $_GET['act'] : 0 ?>">
