...
/*
FORMULARIO PARA REALIZAR BUSQUEDAS DE PERSONAS POR APELLIDOS, PUEDE SER LLAMADO DESDE CUALQUIER LADO **SOLO USANDO ENLACES GREYBOX**
pasar mediante GET el parametro policia=(1,0)
1 si se desea solo policias
0 si se desea todas las personas
========================================================================================================================================
ej: <a href="persona_list.php?policia=1" class="boton_general" onclick="return GB_showPage('Titulo', this.href)"><span>Buscar</span></a>
========================================================================================================================================
*/
//echo 'Aqui:'.$_GET['policia'];
...
<head>
  ...
  <script>
    function validar() {
      ...
      var field = document.getElementById('apellido1');
      ...
      <div id="content">
        ...
        <div id="content_mid">
          <div id="contenido">
                ...
                <table class="tabla1" style="width:950px">
                  <tr>
                    ...
                    <td colspan="2">
                      ...
                      <input type="hidden" name="vst" id="vst" value="<?php echo isset($_GET['vst']) ? $_GET['vst'] : 0 ?>" />
                      <input type="hidden" name="eje" id="eje" value="<?php echo isset($_GET['eje']) ? $_GET['eje'] : 0 ?>" />
                    </td>
                    <td><input type="button" onclick="enviarConsulta()" value="Buscar" class="boton_general" /></td>
                  </tr>
                  <tr>
                    <td colspan="4">
                      <hr />
            ...
            $maxRows_Recordset1 = 500;    /* Numero de registros en cada pgina de la grilla*/
